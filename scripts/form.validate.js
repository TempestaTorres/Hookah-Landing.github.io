...
function validateForm(form) {
    ...
    const formThanks = document.querySelector('.form-thanks');
    const errorElement = document.querySelector('.text-help');
        ...
        if (valid) {
            ...
            $.ajax({
                ...
                .done(function (jsonObject) {
                    ...
                    console.log('Answer: ' + jsonObject.success);
                    ...
                    if (jsonObject.success) {
                        ...
                        hideElement(formMain, formThanks);
    ...
    function hideElement(Element, target) {
        /*
        Element.animate([
                {
                    opacity: 1,
    ...
    function runTextEffect(target) {
        const el = document.querySelector(target);

        for (var e, n = el, i = n.innerHTML.replace("&amp;", "&").split(""), a = "", o = 0, s = i.length; s > o; o++) {
            e = i[o].replace("&", "&amp");
    ...
    function runSmoke() {
        ...
        function animateSmoke(currentTime) {
